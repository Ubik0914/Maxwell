...
/**
 * The task list while it is still being fetched — rows of the same
 * height and rhythm as the real ones, so the list doesn't reflow when
 * the data lands.
 *
 * One story's list and the whole workspace's are the same list, so they
 * wait behind the same placeholder rather than two that drift apart.
 */
