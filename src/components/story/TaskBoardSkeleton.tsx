...
/**
 * The board while it is still being fetched — real column frames with
 * placeholder cards inside them, at the same widths the board uses, so
 * what arrives lands in place rather than replacing a different shape.
 *
 * Shared by one story's board and the workspace's, which are the same
 * board over a different set of tasks.
 */
